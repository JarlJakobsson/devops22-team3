    ...
    if choice == "q" or choice == "Q":
        ...
        with open("jsonpersons.json") as f:
            ...
            for p in json_persons["persons"]:
                ...
                sql_connection.execute(INSERT_PERSON_DATA, tuple(p.values()))
...
"""
        ...
        if print_choice == "q" or choice == "Q":
            ...
            try:
                cursor = sql_connection.cursor()
                cursor.execute('''SELECT firstname, lastname, birth, address, hobbyname 
                                FROM person AS p 
        ...
        try:
            ...
            sql_connection.execute(INSERT_HOBBY_DATA, (userid, input_hobby))
            list_hobbies()
        except:
            except_msg()
